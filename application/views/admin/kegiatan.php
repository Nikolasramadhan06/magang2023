...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a class="btn btn-success pull-right" href="<?php echo base_url('admin/kegiatan/tambah_data/'); ?>">Tambah Data</a>
</div>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/kegiatan/hapuskegiatan/' . $row->id_kegiatan); ?>">
