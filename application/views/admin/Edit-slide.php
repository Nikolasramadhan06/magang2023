      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url('admin/slide/aksiSlide'); ?>" method="post" enctype="multipart/form-data">
              
            <div class="form-group">
                <label>Judul</label>
                <input type="hidden" name="id_gambar" class="form-control" value="<?php echo $slide['id_gambar']; ?>">
